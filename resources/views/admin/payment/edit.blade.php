...
@section('description', __('Update payment method details'))
...
@section('content')
    ...
    <div class="admin-card">
        <div class="admin-card-header">
            <h5 class="mb-0">{{ __('Edit Payment Method') }}</h5>
        </div>
        <div class="admin-card-body">
            <form method="POST" action="{{ route('admin.payment.update', $paymentMethod) }}">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('icon') is-invalid @enderror" id="icon" name="icon" value="{{ old('icon', $paymentMethod->icon) }}">
                        </div>
                        @error('icon')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control @error('fee') is-invalid @enderror" id="fee" name="fee" value="{{ old('fee', $paymentMethod->fee) }}" step="0.01" min="0">
                    </div>
                    @error('fee')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-save me-1"></i> {{ __('Update Payment Method') }}
                    </button>
                </div>
            </form>
        </div>
